...
export default function Hero() {
  ...
  return (
    <section ref={ref} className="relative min-h-[160vh] overflow-hidden pt-0 pb-32">
      ...
      {/* New Unified Background with Salad Bowls */}
      <div 
      ...
      <div className="relative flex min-h-screen pt-24 sm:pt-28 md:pt-32 items-center justify-center">

        {/* CENTER VIDEO - Now the main focus */}
        <div className="flex-1 flex items-center justify-center relative px-4 sm:px-6 max-w-7xl mx-auto">
          <motion.div
            style={{ y: videoY }}
