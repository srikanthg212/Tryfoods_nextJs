...
export default function Footer() {
  return (
    <footer className="relative py-12 sm:py-16 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative z-10">
        ...
        <div>
          <h4 className="font-semibold mb-4 sm:mb-6 text-base sm:text-lg text-white drop-shadow-md">Quick Links</h4>
      ...
      <div className="text-center mt-12 sm:mt-16 text-xs sm:text-sm text-white/70 border-t border-white/10 pt-6 sm:pt-8 relative z-10 drop-shadow-sm px-4">
